...
func (c *mailServiceClient) SendMail(ctx context.Context, in *MailRequest, opts ...grpc.CallOption) (*MailReply, error) {
...
func (UnimplementedMailServiceServer) SendMail(context.Context, *MailRequest) (*MailReply, error) {
